...
**For this session: Dotfiles project only**

Filter Linear queries to Dotfiles:
```
list_issues with project="Dotfiles"
```

Check these files for project context:
- `/Users/olliegilbey/dotfiles/CLAUDE.md` - Project instructions
- `/Users/olliegilbey/dotfiles/README.md` - Project overview
- `/Users/olliegilbey/dotfiles/.claude/CLAUDE.md` - Global directives
- Any other `.md` files in working directory

## Example Workflows

### Workflow 1: "What should I work on next?"
1. Read project docs for current focus
2. List all open Dotfiles issues
